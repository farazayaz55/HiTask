    ...
    <Routes>
      <Route path="/">
        ...
        <Route path="projects">
          ...
          <Route path="new">
            <Route index element={<New inputs={projectInputs}  title="Projectsssss!"></New>}></Route>
          </Route>
        </Route>
        <Route path="teams">
          <Route index element={<List1></List1>}></Route>
          <Route path="new" element={<New1 inputs={teamInputs} title="Teamsss!"></New1>}></Route>
        </Route>
        <Route path="tasks">
          <Route index element={<List2></List2>}></Route>
          <Route path="new" element={<New2 inputs={TaskInputs} title="Taskssss!"></New2>}></Route>
        </Route>
      </Route>
    </Routes>
  </BrowserRouter>
